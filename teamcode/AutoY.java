...
@Autonomous(name="Y Start Right just push")
public class AutoY extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        moveSetPowers(0.0,0.5,0.0);
        while (opModeIsActive() && (runtime.seconds() < 21.0*spi)) {
            telemetryAprilTag();
            telemetry.update();
        }
        ...
        runtime.reset();
        moveSetPowers(0.0,0.5,0.0);
        while (opModeIsActive() && (runtime.seconds() < 50.0*spi)) {
            telemetryAprilTag();
            telemetry.update();
        }
        ...
        runtime.reset();
        moveSetPowers(-0.5,0.0,0.0);
        while (opModeIsActive() && (runtime.seconds() < 10.0*spi)) {
            telemetryAprilTag();
            telemetry.update();
        }
        runtime.reset();
        ...
        // did not feel like making a for loop
        runtime.reset();
        moveSetPowers(0.0,-0.5,0.0);
        while (opModeIsActive() && (runtime.seconds() < 50.0*spi)) {
            telemetryAprilTag();
